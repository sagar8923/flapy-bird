...
def mainGame():
    ...
    upperPipes = [
        ...
        {'x': SCREENHEIGHT+200+(SCREENHEIGHT/2), 'y':newPipe2[0]['y']},
    ]
    # my List of lower pipes
    lowerPipes = [
        {'x': SCREENHEIGHT+200, 'y':newPipe1[1]['y']},
        {'x': SCREENHEIGHT+200+(SCREENHEIGHT/2), 'y':newPipe2[1]['y']},
    ]
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird by VARUN GUPTA')
